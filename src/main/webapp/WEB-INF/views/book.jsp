...
<body>
	...
	<div id="content">
		<br>
		<table class="books">
			<tr class="books"><th class="books">Author</th><th>Genre</th><th>Title</th></tr>
    		<tr>
      		<td class="books"><c:out value="${book.author}" /></td>
      		<td class="books"><c:out value="${book.genre}" /></td>
      		<td class="books"><c:out value="${book.title}" /></td>
    		</tr>
    	</table>
    	<br>
    	<table class="books">
  			<tr class="books"><th class="books">Description</th></tr>
  			<tr class="books"><td  class="books">
  				<pre><c:out value="${book.description}" /></pre>
  			</td></tr>
		</table>
